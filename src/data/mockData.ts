...
export const REGIONS_DATA: Record<RegionId, RegionData> = {
  ...
  south: {
    ...
    accuracy: 99.6,
    status: 'optimal',
    primary_pattern: 'Highest nationwide automation benchmark with 97.4% straight-through processing.',
  ...
  west: {
    ...
    accuracy: 98.1,
    status: 'attention',
    primary_pattern: 'Slower average processing latencies (3.8 min vs 2.8 min natl avg) caused by multi-tiered state environmental compliance documents.',
    ...
    ai_recommendation: 'Enable parallel microservice extraction nodes for West regional document queues to halve document latency.'
  },
  southeast: {
    id: 'southeast',
